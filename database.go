...
func setupTables() {
	var t = []struct {
		...
		{"agent", `CREATE TABLE agent ( gid varchar(32) NOT NULL, iname varchar(64) DEFAULT NULL, level tinyint(4) NOT NULL DEFAULT '1', OneTimeToken varchar(64) NOT NULL DEFAULT UUID(), VVerified tinyint(1) NOT NULL DEFAULT '0', Vblacklisted tinyint(1) NOT NULL DEFAULT '0', Vid varchar(40) DEFAULT NULL, RocksVerified tinyint(1) NOT NULL DEFAULT '0', RAID tinyint(1) NOT NULL DEFAULT '0', RISC tinyint(1) NOT NULL DEFAULT '0', PRIMARY KEY (gid), UNIQUE KEY iname (iname), UNIQUE KEY OneTimeToken (OneTimeToken), UNIQUE KEY Vid (Vid)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;`},
...
func upgradeTables() {
	var upgrades = []struct {
		...
		{"SELECT OneTimeToken FROM agent LIMIT 1", "ALTER TABLE agent CHANGE lockey OneTimeToken varchar(64) NOT NULL DEFAULT UUID()"},
	}
