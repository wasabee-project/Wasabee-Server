...
func setupTables() {
	var t = []struct {
		...
		{"document", `CREATE TABLE document ( id varchar(64) COLLATE utf8mb4_bin NOT NULL, content longblob NOT NULL, upload datetime NOT NULL DEFAULT CURRENT_TIMESTAMP, expiration datetime DEFAULT NULL, views int(10) unsigned NOT NULL DEFAULT '0', PRIMARY KEY (id)) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;`},
		...
		{"portal", `CREATE TABLE portal ( ID varchar(64) NOT NULL, opID varchar(64) NOT NULL, name varchar(128) NOT NULL, loc point NOT NULL, comment text, hardness varchar(64) DEFAULT NULL, UNIQUE KEY ID (ID,opID), KEY fk_operation_id (opID), SPATIAL KEY sp_portal (loc)) ENGINE=Aria DEFAULT CHARSET=utf8mb4 PAGE_CHECKSUM=1;`},
