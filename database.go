...
func setupTables() {
	var t = []struct {
		...
		{"operation", `CREATE TABLE operation (ID varchar(64) NOT NULL, name varchar(128) NOT NULL DEFAULT "new op", gid varchar(32) NOT NULL, color varchar(16) NOT NULL DEFAULT "00FF00", teamID varchar(64) NOT NULL DEFAULT "", modified DATETIME NOT NULL DEFAULT NOW(), PRIMARY KEY (ID), KEY gid (gid), CONSTRAINT fk_operation_agent FOREIGN KEY (gid) REFERENCES agent (gid) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4`},
