...
func setupTables() {
	var t = []struct {
		...
		{"rocks", `CREATE TABLE rocks ( gid char(21) NOT NULL, tgid int(11) DEFAULT NULL, agent varchar(64) DEFAULT NULL, verified tinyint(4) NOT NULL DEFAULT 0, smurf tinyint(4) NOT NULL DEFAULT 0, fetched timestamp NOT NULL DEFAULT current_timestamp(), PRIMARY KEY (gid), CONSTRAINT fk_rocks_gid FOREIGN KEY (gid) REFERENCES agent (gid) ON DELETE CASCADE) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;`},
