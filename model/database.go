...
func upgradeTables() {
	var upgrades = []struct {
		...
		// {"SELECT DATA_TYPE FROM information_schema.columns WHERE table_schema = Database() AND table_name = 'agent' AND column_name = 'fetched'", "ALTER TABLE agent DROP Vverified, DROP Vblacklisted, DROP Vid, DROP RocksVerified, DROP Vname, DROP rocksname, DROP RAID, DROP level, ADD fetched datetime not null default current_timestamp()"},
	}
